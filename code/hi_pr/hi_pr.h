...
public:
	...
	/* void construct(int nV, int nE, const tcap * E, const tcap * cap, const tcap * excess); */
...
private:
	...
	*/
	int parse(long *n_ad, long *m_ad, node **nodes_ad, arc **arcs_ad, float **cap_ad, node **source_ad, node    **sink_ad, long *node_min_ad);
...
public:
	double flow0;             /* added flow value */
	void add_arc(int tail, int head, float cap1, float cap2, long *& arc_first, long *& arc_tail, long & pos_current, arc *& arc_current, node *& nodes, long & node_min, long & node_max, long & no_alines);
};
